...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4">
      ...
      >
        <h1 className="text-xl font-bold text-slate-900">Daftar Kedai</h1>
          ...
          {slug.length > 0 && (
            <span className="mt-1 inline-block text-xs">
              {!slugValid ? (
                ...
                <span className="text-emerald-600">✓ Slug tersedia</span>
              ) : slugAvailable === false ? (
                <span className="text-rose-500">✗ Slug sudah dipakai</span>
              ) : null}
            </span>
          )}
        </label>
