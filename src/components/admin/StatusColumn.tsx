...
export default function StatusColumn({
  ...
  return (
    <div
      ...
      className={`flex min-h-[60vh] w-64 shrink-0 flex-col rounded-xl border bg-muted p-2 transition ${
        isDropTarget ? "border-sky-500/50 ring-2 ring-sky-500/40" : "border-border"
      }`}
    >
